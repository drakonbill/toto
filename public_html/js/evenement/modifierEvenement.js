...
$(document).ready(function() {
		...
		$.ajax({
			...
			data: $("div#event_organise div.fun-block-inside2 div#event_organise_where #cp").serialize(),
			dataType: 'json',
			success:
			function(json) {
		...
		if(eventdata_pays == 1) {
			$("div.dropdownCell").attr({'value':'1'}).text("France");
		}
		else if(eventdata_pays == 2) {
			$("div.dropdownCell").attr({'value':'2'}).text("Belgique");
		}
